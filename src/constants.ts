...
export const PLATFORM_CREATOR_ADDRESS = new PublicKey(
  'GpP898ZuTt4fMAN1RbimhUuF8rWoY962oPo7s1nc856Y',
)
...
export const PLATFORM_SHARABLE_URL = 'degenparadise.vercel.app/'

// Creator fee (in %)
export const PLATFORM_CREATOR_FEE = 0.015 // 1.5% (1.5/100 = 0.015)  !!max 5%!!
